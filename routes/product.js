...
router.patch("/:productId/feature", verify, verifyAdmin, productController.featureProduct);

router.patch("/:productId/dontfeature", verify, verifyAdmin, productController.dontFeatureProduct);
